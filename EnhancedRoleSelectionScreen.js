...
const EnhancedRoleSelectionScreen = ({ navigation }) => {
  const handleRoleSelection = (role) => {
    if (role === 'admin') {
      // Navigate to the new dashboard screen which will handle admin login
      navigation.navigate('UserDashboard');
    } else {
      navigation.navigate('EnhancedLogin', { selectedRole: role });
    }
  };
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <View style={styles.buttonContent}>
              ...
              <Text style={styles.buttonSubtitle}>System Administration</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => handleRoleSelection('ngo')}
            activeOpacity={0.8}
          >
            <View style={styles.buttonContent}>
